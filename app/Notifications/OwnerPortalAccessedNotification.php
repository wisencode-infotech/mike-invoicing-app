 ...
 */
class OwnerPortalAccessedNotification extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject(__('Portal opened for Invoice :number', ['number' => $this->invoice->invoice_number]))
            ->line(__(':customer opened the portal link for invoice :number.', [
